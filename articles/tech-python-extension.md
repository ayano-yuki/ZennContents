...
Swiftには他の言語ではあまり見られない独特な文法や機能が多く、触っていてとても新鮮でした。中でも特に印象に残ったのが「`extension`」です。自作のクラスや構造体に対して、継承せずに機能を拡張できる点がとても便利で、関心の分離もしやすく、コードの見通しも良くなります。
